...
namespace Minsk.Tests.CodeAnalysis.Syntax
{
    public class ParserTests
    {
        ...
        public void Parser_binary_expression_honors_precendence(SyntaxKind op1, SyntaxKind op2)
        {
        ...
        public void Parser_unary_expression_honors_precendence(SyntaxKind unaryKind, SyntaxKind binaryKind)
        {
        ...
        {
            foreach (var unaryOp in SyntaxFacts.GetUnaryOperatorKinds())
            {
                foreach (var binaryOp in SyntaxFacts.GetBinaryOperatorKinds())
                {
